...
import (
	...
	_ "github.com/lib/pq"
	"github.com/tr-coreutils/tr-url-shortener/config"
	ih "github.com/tr-coreutils/tr-url-shortener/internal/http"
	urlshortner "github.com/tr-coreutils/tr-url-shortener/internal/url-shortner"
)
...
func Initalize() (*App, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("Error initlizing application %s", err)
	}
	return app, nil
}
